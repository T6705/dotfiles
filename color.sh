...
cursor_background_color_value="'rgb(251,241,199)'"
cursor_foreground_color_value="'rgb(40,40,40)'"
...
#font_value="'Hack Nerd Font Mono 11'"
font_value="'FiraCode Nerd Font 11'"
