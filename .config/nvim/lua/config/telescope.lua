...
map('n', '<leader>d', ':Telescope lsp_definitions<CR>zzzv', opts)
map('n', '<leader>i', ':Telescope lsp_implementations<CR>zzzv', opts)
map('n', '<leader>r', ':Telescope lsp_references<CR>zzzv', opts)
map('n', '<leader>td', ':Telescope lsp_type_definitions<CR>', opts)
